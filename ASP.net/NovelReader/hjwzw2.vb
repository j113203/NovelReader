Public Class hjwzw2
    ...
    Function get_(id As String, about As String) As String
        Try
            ...
            For Each c As Match In Regex.Matches(a.DownloadString("http://t.hjwzw.com/Read/" + id), "<p>(.*)</p>")
                b.Append(c.Groups(0).Value)
            Next
            Return b.ToString + public_.hotkey("http://t.hjwzw.com/Read/" + d(0).ToString + "," + (current - 1).ToString, "http://t.hjwzw.com/Read/" + d(0).ToString + "," + (current + 1).ToString)
